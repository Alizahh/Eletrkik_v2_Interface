...
export const RPC_PROVIDERS: { [key in SupportedChainId]: StaticJsonRpcProvider } = {
  ...
  //Change
  [SupportedChainId.LIGHTLINK_PEGASUS_TESTNET]: new AppJsonRpcProvider(SupportedChainId.LIGHTLINK_PEGASUS_TESTNET),
  [SupportedChainId.LIGHTLINK_PHOENIX_MAINNET]: new AppJsonRpcProvider(SupportedChainId.LIGHTLINK_PHOENIX_MAINNET),
}
