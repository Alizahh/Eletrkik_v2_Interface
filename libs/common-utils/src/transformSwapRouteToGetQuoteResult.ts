...
import { routeAmountsToString, SwapRoute } from '@aaran1337/smart-order-router-test'
import { Pool } from '@uniswap/v3-sdk'

import { QuoteResult, QuoteState  } from '../../../apps/cowswap-frontend/src/legacy/state/routing/types'
import { QuoteData, V2PoolInRoute, V3PoolInRoute } from '../../../apps/cowswap-frontend/src/legacy/state/routing/types'
