...
import { AutoRow, Row } from '../../../../../../../libs/ui/src/pure/Row'
import Badge from 'legacy/components/Badge'
import { ThemedText, Z_INDEX } from 'legacy/theme'
import { RoutingDiagramEntry } from 'modules/trade/utils/getRoutingDiagramEntries'
import { CurrencyLogo } from 'common/pure/CurrencyLogo'
// import { MouseoverTooltip } from '../../../../../../../libs/ui/src/pure/MouseOverTooltip'
import DoubleCurrencyLogo from 'legacy/components/DoubleLogo'
import { useTokenInfoFromActiveList } from 'modules/trade/hooks/useTokenInfoFromActiveList'
    ...
    <RouteRow>
      ...
      <OpaqueBadge>
        {protocol === Protocol.MIXED ? (
          ...
          <ProtocolBadge>{/* <BadgeText fontSize={12}>{protocol.toUpperCase()}</BadgeText> */}</ProtocolBadge>
        )}
