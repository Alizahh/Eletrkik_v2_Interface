...
export const turnOnToggle = keyframes`
  from {
    margin-left: 0em;
    margin-right: 2.2em;
  }
...
export const turnOffToggle = keyframes`
  from {
    margin-left: 2.2em;
    margin-right: 0em;
  }
...
export const ToggleElementHoverStyle = (hasBgColor: boolean, theme: any, isActive?: boolean) =>
    hasBgColor
        ? {
            opacity: '0.8',
        }
